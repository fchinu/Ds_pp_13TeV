...
if __name__ == '__main__':
    ...
    c.cd(3)
    h_frame = ROOT.gPad.DrawFrame(1., 0., 5000., 0.9, ";#LTd#it{N}_{ch}/d#it{#eta}#GT ;#it{#sigma}_{D_{s}^{+}}/#it{#sigma}_{D^{+}}")
    graph_stat_lhcb_4_6_f, graph_syst_lhcb_4_6_f = get_graphs_2()
    ...
    graph_stat_lhcb_4_6_b, graph_syst_lhcb_4_6_b = get_graphs_1()
    ...
    graph_stat_lhcb_6_8_f, graph_syst_lhcb_6_8_f = get_graphs_2()
    ...
    graph_stat_lhcb_6_8_b, graph_syst_lhcb_6_8_b = get_graphs_1()
    ...
    graph_stat_lhcb_8_12_f, graph_syst_lhcb_8_12_f = get_graphs_2()
    ...
    graph_stat_lhcb_8_12_b, graph_syst_lhcb_8_12_b = get_graphs_1()
    ...
    # h_frame.GetYaxis().ChangeLabel(1, 1, 0)
    # g_alice_pp_1_2 = draw_alice_pp(1, 2, c=colors[7], s=2.5, m=ROOT.kFullCircle)
    # #y_text.Draw()
    ...
    # graph_stat_lhcb_2_4_f, graph_syst_lhcb_2_4_f = get_graphs_2()
    # draw_graphs(graph_stat_lhcb_2_4_f, graph_syst_lhcb_2_4_f, c=colors[7], s=4., m=ROOT.kFullDiamond)
    # graph_stat_alice_2_4, graph_syst_alice_2_4 = draw_alice_pbpb(2, 4, c=colors[7], s=2.5, m=ROOT.kOpenCircle)
    # g_alice_pp_2_4 = draw_alice_pp(2, 4, c=colors[7], s=2.5, m=ROOT.kFullCircle)
    # #alice_text.Draw()
    # #y_text.Draw()
    ...
    # draw_graphs(graph_stat_lhcb_4_6_f, graph_syst_lhcb_4_6_f, c=colors[7], s=4., m=ROOT.kFullDiamond)
    # draw_alice_pbpb(4, 6, c=colors[7], s=2.5, m=ROOT.kOpenCircle)
    # draw_alice_pp(4, 6, c=colors[7], s=2.5, m=ROOT.kFullCircle)
    # #alice_text.Draw()
    # #y_text.Draw()
    # x, y = to_pad_coordinates(0.05, 0.85)
    # pt_text.DrawLatexNDC(x, y, '4#kern[1.]{<}#kern[.5]{#it{p}_{T}}#kern[.5]{<}#kern[1.]{6} GeV/#it{c}')
    ...
    # draw_graphs(graph_stat_lhcb_6_8_f, graph_syst_lhcb_6_8_f, c=colors[7], s=4., m=ROOT.kFullDiamond)
    # draw_alice_pbpb(6, 8, c=colors[7], s=2.5, m=ROOT.kOpenCircle)
    # draw_alice_pp(6, 8, c=colors[7], s=2.5, m=ROOT.kFullCircle)
    # #alice_text.Draw()
    # #y_text.Draw()
    # x, y = to_pad_coordinates(0.05, 0.85)
    # pt_text.DrawLatexNDC(x, y, '6#kern[1.]{<}#kern[.5]{#it{p}_{T}}#kern[.5]{<}#kern[1.]{8} GeV/#it{c}')
    ...
    # draw_graphs(graph_stat_lhcb_8_12_f, graph_syst_lhcb_8_12_f, c=colors[7], s=4., m=ROOT.kFullDiamond)
    # draw_alice_pbpb(8, 12, c=colors[7], s=2.5, m=ROOT.kOpenCircle)
    # draw_alice_pp(8, 12, c=colors[7], s=2.5, m=ROOT.kFullCircle)
    # #alice_text.Draw()
    # #y_text.Draw()
    # x, y = to_pad_coordinates(0.05, 0.85)
    # pt_text.DrawLatexNDC(x, y, '8#kern[1.]{<}#kern[.5]{#it{p}_{T}}#kern[.5]{<}#kern[.5]{12} GeV/#it{c}')
    ...
    # h_frame = ROOT.gPad.DrawFrame(1., 0., 5000., 1., ";d#it{N}_{ch}/d#it{#eta};#sigma_{D_{s}^{+}}/#sigma_{D^{+}}")
    # h_frame.GetXaxis().ChangeLabel(1, 1, 0)
    # draw_alice_pp(12, 24, c=colors[7], s=2.5, m=ROOT.kFullCircle)
    # draw_alice_pbpb(12, 24, c=colors[7], s=2.5, m=ROOT.kOpenCircle)
    # #alice_text.Draw()
    # #y_text.Draw()
    # x, y = to_pad_coordinates(0.05, 0.85)
    # pt_text.DrawLatexNDC(x, y, '12#kern[1.]{<}#kern[.5]{#it{p}_{T}}#kern[.5]{<}#kern[.5]{24} GeV/#it{c}')
